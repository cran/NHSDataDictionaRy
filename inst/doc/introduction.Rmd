...
A contribution has been added to the package to allow for the OpenSafely data to be examined. To get the [OpenSafely data](https://codelists.opensafely.org/) you can specify the code list required and this will pull it into a list. To do this follow the below example:
...
```
To limit the list to a specific timed list - you can add the next level down to bring back a specific list:
```{r opensafely_two}
...
To understand the OpenSafely site, please see [Documentation](https://codelists.opensafely.org/docs/).
